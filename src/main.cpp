      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          if (!pf.initialized()) {
            ...
            std::cout<<"init x,y,z"<<sense_x<<","<<sense_y<<std::endl;
            //std::cout<<"init weight"<<pf.particles[500].weight<<std::endl;
          } else {
			...
			//std::cout<<"previous velocity"<<previous_velocity<<std::endl;
	      ...
	      //std::cout<<"sensor observation x;y "<<noisy_observations[1].x<<";"<<noisy_observations[1].y <<std::endl;
          // Update the weights and resample
          pf.updateWeights(sensor_range, sigma_landmark, noisy_observations, map);
          std::cout<<"update weight"<<pf.particles[500].weight<<std::endl;
          pf.resample();
